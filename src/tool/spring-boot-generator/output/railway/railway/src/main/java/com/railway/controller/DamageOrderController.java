...
public class DamageOrderController {
    ...
    public R deleteDamageOrderByOrderNo(@PathVariable String orderNo) {
        return R.doResponse(damageOrderService.deleteDamageOrderByOrderNo(orderNo));
    }

    @ApiOperation("")
    @PutMapping(path = "/damageOrder/{orderNo}")
    public R updateDamageOrderByOrderNo(@PathVariable String orderNo, @Validated @ModelAttribute UpdateDamageOrderByOrderNoReq req) {
        return R.doResponse(damageOrderService.updateDamageOrderByOrderNo(orderNo, req));
    }

    @ApiOperation("")
    @GetMapping(path = "/damageOrder/{orderNo}")
    public R<DamageOrder> getDamageOrderByOrderNo(@PathVariable String orderNo) {

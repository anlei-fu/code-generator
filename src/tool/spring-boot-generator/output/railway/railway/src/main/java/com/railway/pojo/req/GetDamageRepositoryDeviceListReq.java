...
@Getter
@Setter
public class GetDamageRepositoryDeviceListReq extends PageReq {
    ...
    @ApiModelProperty("累计通过总重 min")
    private Float totalWeightMin;

    @ApiModelProperty("累计通过总重 max")
    private Float totalWeightMax;

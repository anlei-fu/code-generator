...
public class UpdateDetectStaffInfoCopyByIdParams {

    @Getter
    @Setter
    private Integer id;

    private UpdateDetectStaffInfoCopyByIdReq req;

    public UpdateDetectStaffInfoCopyByIdParams(Integer id, UpdateDetectStaffInfoCopyByIdReq req) {
        this.id = id;
        this.req = req;
    }

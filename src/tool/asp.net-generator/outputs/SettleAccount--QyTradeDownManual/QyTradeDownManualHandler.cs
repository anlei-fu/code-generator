...
{
    /// <summary>
    /// 逻辑处理：QyTradeDownManual(订单表)
    /// </summary>
    public class QyTradeDownManualHandler : IQyTradeDownManualHandler
    {
        private IQyTradeDownManualDataAccess dbAccess;
        ILogger logger = LoggerManager.Instance.GetLogger("web");
        public QyTradeDownManualHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IQyTradeDownManualDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MQyTradeDownManual GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MQyTradeDownManual GetSingleData(MQyTradeDownManual query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MQyTradeDownManual> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MQyTradeDownManual> GetDataList(MQyTradeDownManual query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MQyTradeDownManual query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MQyTradeDownManual> GetPagerDataList(MQyTradeDownManual query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MQyTradeDownManual query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MQyTradeDownManual vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MQyTradeDownManual vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MQyTradeDownManual vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MQyTradeDownManual vo)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public int GetCount(MQyTradeDownManual query, MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MQyTradeDownManual vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MQyTradeDownManual> GetDataListByTemplate(string xmlTemplateName, MQyTradeDownManual vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MQyTradeDownManual vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MQyTradeDownManual GetSingleDataByTemplate(string xmlTemplateName, MQyTradeDownManual vo)
        {

...
{
    /// <summary>
    /// 逻辑处理：YxBaseAgent(订单表)
    /// </summary>
    public class YxBaseAgentHandler : IYxBaseAgentHandler
    {
        private IYxBaseAgentDataAccess dbAccess;
        private ILogger logger = LoggerManager.Instance.GetLogger("web");

        public YxBaseAgentHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IYxBaseAgentDataAccess>();
        }
        ...
        /// <returns></returns>
        public MYxBaseAgent GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MYxBaseAgent GetSingleData(MYxBaseAgent query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MYxBaseAgent> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MYxBaseAgent> GetDataList(MYxBaseAgent query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MYxBaseAgent query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MYxBaseAgent> GetPagerDataList(MYxBaseAgent query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MYxBaseAgent query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MYxBaseAgent vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MYxBaseAgent vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MYxBaseAgent vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MYxBaseAgent vo)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public int GetCount(MYxBaseAgent query, MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MYxBaseAgent vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MYxBaseAgent> GetDataListByTemplate(string xmlTemplateName, MYxBaseAgent vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MYxBaseAgent vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MYxBaseAgent GetSingleDataByTemplate(string xmlTemplateName, MYxBaseAgent vo)
        {

...
{
    /// <summary>
    /// 逻辑处理：QyTradeDownFund(订单表)
    /// </summary>
    public class QyTradeDownFundHandler : IQyTradeDownFundHandler
    {
        private IQyTradeDownFundDataAccess dbAccess;
        ILogger logger = LoggerManager.Instance.GetLogger("web");
        public QyTradeDownFundHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IQyTradeDownFundDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MQyTradeDownFund GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MQyTradeDownFund GetSingleData(MQyTradeDownFund query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MQyTradeDownFund> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MQyTradeDownFund> GetDataList(MQyTradeDownFund query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MQyTradeDownFund query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MQyTradeDownFund> GetPagerDataList(MQyTradeDownFund query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MQyTradeDownFund query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MQyTradeDownFund vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MQyTradeDownFund vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MQyTradeDownFund vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MQyTradeDownFund vo)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public int GetCount(MQyTradeDownFund query, MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MQyTradeDownFund vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MQyTradeDownFund> GetDataListByTemplate(string xmlTemplateName, MQyTradeDownFund vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MQyTradeDownFund vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MQyTradeDownFund GetSingleDataByTemplate(string xmlTemplateName, MQyTradeDownFund vo)
        {

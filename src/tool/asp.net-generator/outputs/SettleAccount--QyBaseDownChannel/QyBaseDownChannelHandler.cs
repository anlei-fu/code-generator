...
{
    /// <summary>
    /// 逻辑处理：QyBaseDownChannel(订单表)
    /// </summary>
    public class QyBaseDownChannelHandler : IQyBaseDownChannelHandler
    {
        private IQyBaseDownChannelDataAccess dbAccess;
        ILogger logger = LoggerManager.Instance.GetLogger("web");
        public QyBaseDownChannelHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IQyBaseDownChannelDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MQyBaseDownChannel GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MQyBaseDownChannel GetSingleData(MQyBaseDownChannel query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MQyBaseDownChannel> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MQyBaseDownChannel> GetDataList(MQyBaseDownChannel query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MQyBaseDownChannel query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MQyBaseDownChannel> GetPagerDataList(MQyBaseDownChannel query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MQyBaseDownChannel query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MQyBaseDownChannel vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MQyBaseDownChannel vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MQyBaseDownChannel vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MQyBaseDownChannel vo)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public int GetCount(MQyBaseDownChannel query, MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MQyBaseDownChannel vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MQyBaseDownChannel> GetDataListByTemplate(string xmlTemplateName, MQyBaseDownChannel vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MQyBaseDownChannel vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MQyBaseDownChannel GetSingleDataByTemplate(string xmlTemplateName, MQyBaseDownChannel vo)
        {

...
{
    /// <summary>
    /// 逻辑处理：FCLimitRuleUp(订单表)
    /// </summary>
    public class FCLimitRuleUpHandler : IFCLimitRuleUpHandler
    {
        private IFCLimitRuleUpDataAccess dbAccess;
        ILogger logger = LoggerManager.Instance.GetLogger("web");
        public FCLimitRuleUpHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IFCLimitRuleUpDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>
        ...
        /// <returns></returns>
        public MFCLimitRuleUp GetData(string id)
        {
        ...
        /// <returns></returns>   
        public MFCLimitRuleUp GetSingleData(MFCLimitRuleUp query, string orderBy = "",
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns></returns>
        public List<MFCLimitRuleUp> GetDataList(string orderBy = "")
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public List<MFCLimitRuleUp> GetDataList(MFCLimitRuleUp query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
            ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public DataSet GetDataSet(MFCLimitRuleUp query, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public List<MFCLimitRuleUp> GetPagerDataList(MFCLimitRuleUp query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
       public DataSet GetPagerDataSet(MFCLimitRuleUp query, int pageSize, int pageIndex, out int totalCount, string orderBy = "", MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
            totalCount = dbAccess.GetCount(query, mmode, cmode);
        ...
        /// <returns></returns>
        public IResult Save(string id, MFCLimitRuleUp vo)
        {
            bool status=false;
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public IResult Save(MFCLimitRuleUp vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool CreateNew(MFCLimitRuleUp vo)
        {
        ...
        /// <param name="vo">实体数据</param>
        /// <returns></returns>
        public bool Update(MFCLimitRuleUp vo)
        {
        ...
        /// <param name="cmode">条件连接字符串 And 或 OR</param>
        /// <returns></returns>
        public int GetCount(MFCLimitRuleUp query, MatchMode mmode = MatchMode.Exact,
              ConnectMode cmode = ConnectMode.And)
        {
        ...
        /// <returns></returns>
        public object GetScalarByXmlTemplate(string xmlTemplateName, MFCLimitRuleUp vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public List<MFCLimitRuleUp> GetDataListByTemplate(string xmlTemplateName, MFCLimitRuleUp vo)
        {
        ...
        /// <param name="vo">实体</param>
        /// <returns></returns>
        public DataSet GetDataSetByTemplate(string xmlTemplateName, MFCLimitRuleUp vo)
        {
        ...
        /// <param name="id">主键编号</param>
        /// <returns></returns>
        public MFCLimitRuleUp GetSingleDataByTemplate(string xmlTemplateName, MFCLimitRuleUp vo)
        {

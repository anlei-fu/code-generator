...
{
    /// <summary>
    /// Controller：FCLimitRuleUp(流程控制)
    /// </summary>
    public class FCLimitRuleUpController : MainBaseController
    {
        /// <summary>
        /// 显示列表页面数据
        /// </summary>
        ...
        {
            return View(FCLimitRuleUpService.Instance.Query(Request.QueryString));
        }
        /// <summary>
        /// 预览详细信息页面
        /// </summary>
        ...
        {
            return View(FCLimitRuleUpService.Instance.Query(id));
        }
        /// <summary>
        /// 保存或修改页面
        /// </summary>
        ...
        {
            return View(FCLimitRuleUpService.Instance.QueryItem(id));
        }
        /// <summary>
        /// 克隆页面
        /// </summary>
        ...
        {
            return View(FCLimitRuleUpService.Instance.View(id));
        }
        public string Item()
        {
            try
        ...
        public string Delete(string id)
        {
            try
            {
                IResult result = FCLimitRuleUpService.Instance.Delete(id);
                if (result.Status)
                {

...
{
    /// <summary>
    /// 逻辑处理：FCLimtIdInfo(订单表)
    /// </summary>
    public class FCLimtIdInfoHandler : IFCLimtIdInfoHandler
    {
        private IFCLimtIdInfoDataAccess dbAccess;
        ILogger logger = LoggerManager.Instance.GetLogger("web");
        public FCLimtIdInfoHandler()
        {
            dbAccess = DataAccessFactory.Instance.GetProvider<IFCLimtIdInfoDataAccess>();
        }
        /// <summary>
        /// 获取单条数据
        /// </summary>

...
exports.ColumnBuilder = class ColumnBuilder {
         ...
         */
        list(column) {
                return this._setBoolProperty(column, "isList");
        }
         ...
         * @returns {ColumnBuilder}
         */
        _setBoolProperty(item, propertyName) {
                return this._setProperty(item, propertyName, true);
        }
        ...
        _setProperty(item, property, value) {
                if (TYPE.isArray(item)) {
                        ...
                        OBJECT.forEach(item, (key, _) => {
                                this._setPropertyCore(key, property, value);
                        });
                }
                else {

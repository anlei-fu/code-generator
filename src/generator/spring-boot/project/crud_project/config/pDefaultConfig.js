...
exports.pDefaultConfigConfig = {
        table: all.pDefaultConfig,
        name: "PDefaultConfig",
                items: [
                        // add
                        ...
                        new ConfigItemBuilder()
                                ...
                                .alias("t")
                                .includes(collection => {
                                        collection.includes(all.pDefaultConfig.columnsArray)
                                                  .excludes("id")
                                                  .excludes(["createTime","id","lastBackupTime","updateTime",])
                                })
                                .request(request => {
                                        request.path("")
                                               .description("add pDefaultConfig");
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                               .description("delete single pDefaultConfig");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("")
                                               .description("update single pDefaultConfig");;
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                                .description("get single pDefaultConfig");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        // updateTime : expression --- timeRange
                         ...
                         .request(request => {
                                         request.path("detail/page")
                                                .description("get pDefaultConfig page with additional details");;
                        })
                         .req(req => {
                                  req.doCreate()
                                 .excludes("id")

                                 .name("GetPDefaultConfigPageReq")
                         })
                   
                         .resp(resp=>{
                                 resp.doCreate()
                                     .name("PDefaultConfigDetailResp")
                                     .build()
                         })
                         .build(),

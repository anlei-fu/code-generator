...
exports.pBackendConfigConfig = {
        table: all.pBackendConfig,
        name: "PBackendConfig",
                items: [
                        // add
                        ...
                        new ConfigItemBuilder()
                                ...
                                .alias("t")
                                .includes(collection => {
                                        collection.includes(all.pBackendConfig.columnsArray)
                                                  .excludes("id")
                                                  .excludes(["createTime","id","lastBackupTime","updateTime",])
                                })
                                .request(request => {
                                        request.path("")
                                               .description("add pBackendConfig");
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                               .description("delete single pBackendConfig");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("")
                                               .description("update single pBackendConfig");;
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                                .description("get single pBackendConfig");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        // updateTime : expression --- timeRange
                         ...
                         .request(request => {
                                         request.path("detail/page")
                                                .description("get pBackendConfig page with additional details");;
                        })
                         .req(req => {
                                  req.doCreate()
                                 .excludes("id")

                                 .name("GetPBackendConfigPageReq")
                         })
                   
                         .resp(resp=>{
                                 resp.doCreate()
                                     .name("PBackendConfigDetailResp")
                                     .build()
                         })
                         .build(),

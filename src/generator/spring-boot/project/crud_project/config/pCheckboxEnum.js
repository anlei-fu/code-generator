...
exports.pCheckboxEnumConfig = {
        table: all.pCheckboxEnum,
        name: "PCheckboxEnum",
                items: [
                        // add
                        ...
                        new ConfigItemBuilder()
                                ...
                                .alias("t")
                                .includes(collection => {
                                        collection.includes(all.pCheckboxEnum.columnsArray)
                                                  .excludes("id")
                                                  .excludes(["createTime","id","lastBackupTime","updateTime",])
                                })
                                .request(request => {
                                        request.path("")
                                               .description("add pCheckboxEnum");
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                               .description("delete single pCheckboxEnum");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("")
                                               .description("update single pCheckboxEnum");;
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                                .description("get single pCheckboxEnum");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        // updateTime : expression --- timeRange
                         ...
                         .request(request => {
                                         request.path("detail/page")
                                                .description("get pCheckboxEnum page with additional details");;
                        })
                         .req(req => {
                                  req.doCreate()
                                 .excludes("id")

                                 .name("GetPCheckboxEnumPageReq")
                         })
                   
                         .resp(resp=>{
                                 resp.doCreate()
                                     .name("PCheckboxEnumDetailResp")
                                     .build()
                         })
                         .build(),

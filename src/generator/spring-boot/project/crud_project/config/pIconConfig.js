...
exports.pIconConfigConfig = {
        table: all.pIconConfig,
        name: "PIconConfig",
                items: [
                        // add
                        ...
                        new ConfigItemBuilder()
                                ...
                                .alias("t")
                                .includes(collection => {
                                        collection.includes(all.pIconConfig.columnsArray)
                                                  .excludes("id")
                                                  .excludes(["createTime","id","lastBackupTime","updateTime",])
                                })
                                .request(request => {
                                        request.path("")
                                               .description("add pIconConfig");
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                               .description("delete single pIconConfig");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("")
                                               .description("update single pIconConfig");;
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                                .description("get single pIconConfig");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        // updateTime : expression --- timeRange
                         ...
                         .request(request => {
                                         request.path("detail/page")
                                                .description("get pIconConfig page with additional details");;
                        })
                         .req(req => {
                                  req.doCreate()
                                 .excludes("id")

                                 .name("GetPIconConfigPageReq")
                         })
                   
                         .resp(resp=>{
                                 resp.doCreate()
                                     .name("PIconConfigDetailResp")
                                     .build()
                         })
                         .build(),

        ...
        name: "PEnum",
                items: [
                        ...
                        new ConfigItemBuilder()
                                ...
                                .alias("t")
                                .includes(collection => {
                                        collection.includes(all.pEnum.columnsArray)
                                                  .excludes("id")
                                                  .excludes(["createTime","id","lastBackupTime","updateTime",])
                                })
                                .request(request => {
                                        request.path("")
                                               .description("add pEnum");
                                })
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("{id}")
                                               .description("delete single pEnum");;
                                })
                                .req(req => {
                                        req.name("id")
                                           .type("Integer")
                        ...
                        new ConfigItemBuilder()
                                ...
                                .request(request => {
                                        request.path("")
                                               .description("update single pEnum");;
                                })
                        ...
                        // updateTime : expression --- timeRange
                         ...
                         .request(request => {
                                         request.path("detail/page")
                                                .description("get pEnum page with additional details");;
                        })
                         .req(req => {
                                  req.doCreate()
                                 .excludes("id")

                                 .name("GetPEnumPageReq")
                         })
                   
                         .resp(resp=>{
                                 resp.doCreate()
                                     .name("PEnumDetailResp")
                                     .build()
                         })
                         .build(),

...
const { crawlerAnalyze } = require("./../../db/crawlerAnalyze");
...
const modelName = "crawlerAnalyze";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/crawlerAnalyze`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(crawlerAnalyze.columnsArray)
                                .defaultShowingColumns(crawlerAnalyze.columnsArray)
                })
        })
                .select([

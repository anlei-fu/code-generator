...
const { crawlTask } = require("./../../db/crawlTask");
...
const modelName = "crawlTask";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/crawlTask`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(crawlTask.columnsArray)
                                .defaultShowingColumns(crawlTask.columnsArray)
                })
        })
                .select([

...
const { siteAccount } = require("./../../db/siteAccount");
...
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/siteAccount`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(siteAccount.columnsArray)
                                .defaultShowingColumns(siteAccount.columnsArray)
                })
        })
                .select([

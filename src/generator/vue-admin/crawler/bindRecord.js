...
const { bindRecord } = require("./../../db/bindRecord");
...
const modelName = "bindRecord";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/bindRecord`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(bindRecord.columnsArray)
                                .defaultShowingColumns(bindRecord.columnsArray)
                })
        })
                .select([

...
const { systemAlarm } = require("./../../db/systemAlarm");
...
const modelName = "systemAlarm";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/systemAlarm`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(systemAlarm.columnsArray)
                                .defaultShowingColumns(systemAlarm.columnsArray)
                })
        })
                .select([

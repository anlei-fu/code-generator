...
const { cookie } = require("./../../db/cookie");
...
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/cookie`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(cookie.columnsArray)
                                .defaultShowingColumns(cookie.columnsArray)
                })
        })
                .select([

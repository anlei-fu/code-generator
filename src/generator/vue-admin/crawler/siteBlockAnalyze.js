...
const { siteBlockAnalyze } = require("./../../db/siteBlockAnalyze");
...
const modelName = "siteBlockAnalyze";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/siteBlockAnalyze`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(siteBlockAnalyze.columnsArray)
                                .defaultShowingColumns(siteBlockAnalyze.columnsArray)
                })
        })
                .select([

...
const { downSystem } = require("./../../db/downSystem");
...
const modelName = "downSystem";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/downSystem`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(downSystem.columnsArray)
                                .defaultShowingColumns(downSystem.columnsArray)
                })
        })
                .select([

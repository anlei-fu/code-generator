...
const modelName = "crawler";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/crawler`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(crawler.columnsArray)
                                .defaultShowingColumns(crawler.columnsArray)
                })
        })
                .select([

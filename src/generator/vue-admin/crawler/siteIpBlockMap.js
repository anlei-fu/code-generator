...
const { siteIpBlockMap } = require("./../../db/siteIpBlockMap");
...
const modelName = "siteIpBlockMap";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/siteIpBlockMap`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(siteIpBlockMap.columnsArray)
                                .defaultShowingColumns(siteIpBlockMap.columnsArray)
                })
        })
                .select([

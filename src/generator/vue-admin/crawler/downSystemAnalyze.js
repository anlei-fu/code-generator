...
const { downSystemAnalyze } = require("./../../db/downSystemAnalyze");
...
const modelName = "downSystemAnalyze";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/downSystemAnalyze`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(downSystemAnalyze.columnsArray)
                                .defaultShowingColumns(downSystemAnalyze.columnsArray)
                })
        })
                .select([

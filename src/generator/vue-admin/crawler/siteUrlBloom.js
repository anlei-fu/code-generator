...
const { siteUrlBloom } = require("./../../db/siteUrlBloom");
...
const modelName = "siteUrlBloom";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/siteUrlBloom`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(siteUrlBloom.columnsArray)
                                .defaultShowingColumns(siteUrlBloom.columnsArray)
                })
        })
                .select([

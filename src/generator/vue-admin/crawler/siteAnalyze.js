...
const { siteAnalyze } = require("./../../db/siteAnalyze");
...
const modelName = "siteAnalyze";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/siteAnalyze`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(siteAnalyze.columnsArray)
                                .defaultShowingColumns(siteAnalyze.columnsArray)
                })
        })
                .select([

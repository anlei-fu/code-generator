...
const { dynamicUrlJob } = require("./../../db/dynamicUrlJob");
...
const modelName = "dynamicUrlJob";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/dynamicUrlJob`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(dynamicUrlJob.columnsArray)
                                .defaultShowingColumns(dynamicUrlJob.columnsArray)
                })
        })
                .select([

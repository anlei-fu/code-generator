...
import com.jasmine.crawler.controller.SiteBlockAnalyzeController;
...
/**
 * SiteBlockAnalyzeService Tester.
 *
 * @author fuanlei
 * @version 1.0
...
public class SiteBlockAnalyzeServiceTest {

    @Autowired
    private SiteBlockAnalyzeController controller;
    ...
    public void testAdd(){
                ...
                AddSiteBlockAnalyzeReq req =new AddSiteBlockAnalyzeReq();
    ...
    public void testUpdateById(){
                ...
                UpdateSiteBlockAnalyzeReq req =new UpdateSiteBlockAnalyzeReq();
    ...
    public void testGetPage(){
                ...
                GetSiteBlockAnalyzePageReq req =new GetSiteBlockAnalyzePageReq();

...
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/@name`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder
                .pageSitting(setting => {
                         setting.table(table => {
                        table.columns(@name.columnsArray)
                                .defaultShowingColumns(@columns)
                        })
                 })
                .select(@columns)
                .radioGroup([

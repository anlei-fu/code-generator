...
const { proxyBlockAnalyze } = require("./../../db/proxyBlockAnalyze");
...
const modelName = "proxyBlockAnalyze";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/proxyBlockAnalyze`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(proxyBlockAnalyze.columnsArray)
                                .defaultShowingColumns(proxyBlockAnalyze.columnsArray)
                })
        })
                .select([

...
const modelName = "vcode";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/vcode`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(vcode.columnsArray)
                                .defaultShowingColumns(vcode.columnsArray)
                })
        })
                .select([

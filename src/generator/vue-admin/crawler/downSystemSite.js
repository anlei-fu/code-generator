...
const { downSystemSite } = require("./../../db/downSystemSite");
...
const modelName = "downSystemSite";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/downSystemSite`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(downSystemSite.columnsArray)
                                .defaultShowingColumns(downSystemSite.columnsArray)
                })
        })
                .select([

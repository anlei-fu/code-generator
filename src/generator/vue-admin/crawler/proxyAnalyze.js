...
const { proxyAnalyze } = require("./../../db/proxyAnalyze");
...
const modelName = "proxyAnalyze";
const outputFolder = `C:/Users/Administrator/Desktop/Projects/vue-admin/spider/src/components/page/proxyAnalyze`;
...
function main() {
        ...
        let queryPageConfig = queryPageBuilder.pageSitting(setting => {
                setting.filters(filter => {
                        ...
                        table.columns(proxyAnalyze.columnsArray)
                                .defaultShowingColumns(proxyAnalyze.columnsArray)
                })
        })
                .select([
